    ...
    <nav className="sticky top-0 z-100 border-b border-[var(--line)]" style={{ background: "rgba(245, 239, 228, 0.88)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
      <div className="flex items-center justify-between px-8 py-[14px] max-w-[1240px] mx-auto max-[900px]:px-[22px] max-[900px]:py-3">
        ...
        <div className="flex items-center gap-9 max-[900px]:gap-[18px]">
          ...
          <Link href="/learn" className="text-ink-soft no-underline text-[15px] font-medium transition-colors hover:text-forest max-[900px]:hidden">Learn</Link>
          <a href="https://wa.me/19289103669" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-ink-soft no-underline text-[15px] font-medium transition-colors hover:text-forest max-[900px]:hidden">
